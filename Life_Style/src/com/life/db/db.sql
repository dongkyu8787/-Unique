...
SELECT HEALTH_ID, HEALTH_WEIGHT, HEALTH_FOOD, HEALTH_KCAL, HEALTH_REGDATE, HEALTH_DAYS
		FROM HEALTH WHERE HEALTH_ID = 'kakao@이동규'
...
INSERT INTO
		...
		SELECT 'rlead92','kakao@진수'
		FROM MEMBER
		WHERE MEMBER_ID = 'rlead92'
...
INSERT INTO HEALTH VALUES('kakao@진수', 65, '피자', 1600, '1', TO_DATE('20190831','yyyymmdd'), '토');

SELECT * FROM HEALTH WHERE
		HEALTH_ID = 'kakao@진수' AND HEALTH_REGDATE BETWEEN
		'2019-08-13' AND '2019-08-13' ORDER BY HEALTH_REGDATE;
