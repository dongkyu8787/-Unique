...
INSERT INTO ACCOUNT VALUES('kakao@진수', 31, TO_DATE('20190831','yyyymmdd'),'토', 5000, 10500, '식비', 15000); 

SELECT * FROM ACCOUNT WHERE
		ACCOUNT_ID = 'kakao@진수' AND ACCOUNT_DATE BETWEEN
		'2019-08-18' AND '2019-08-24'
...
CREATE TABLE HEALTH(
	...
	HEALTH_DAYS VARCHAR2(10) NOT NULL,
);
