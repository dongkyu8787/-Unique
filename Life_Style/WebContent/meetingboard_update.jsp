...
<section id="meetingboard_update">
	<form action="meetingboard.do" method="post" name="frm">
		...
		<table border="1">
			...
			<tr>
				...
				<input  name="board_title" type="text" value="${boardupdate_dto.board_title }"></td>
			</tr>
			<tr>
			...
			<tr>
				<td>
				나이제한 : <input type="text" name="board_age_min" type="number" min="0" max="200" id="min" onchange="compare()" value="${boardupdate_dto.board_age_min }">~
				<input type="text" name="board_age_max" type="number" min="0" max="200" id="max" onchange="compare()" value="${boardupdate_dto.board_age_max }">
				</td>
			</tr>
			<tr>
				<td>
				최대인원수 : <input type="number" name="board_peoplelimit" min="0" max="50" value="${boardupdate_dto.board_peoplelimit }">
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td>시간제한 : 날짜입력 <input name="board_date" type="datetime-local" value="${boardupdate_dto.board_timelimit }" id="now_date"></td>
			</tr>
			
			<tr>
				<th>글내용</th>
				<td><textarea id="ir12" name="board_content" >${boardupdate_dto.board_content }</textarea></td>
			</tr>
